...
if __name__ == "__main__":
    ...
    fcn_files = sprites.get_images_from_fcn(args.input_fcn, args.upscale_ratio)

    obj_filename = [x for x in fcn_files if x.endswith('.obj')][0]
    sprite_filenames = sprites.parse_obj(fcn_files[obj_filename], fcn_files)

    animation.parse_dat(args.input_dat, args.output, sprite_filenames, fcn_files, args.upscale_ratio, args.start_frame, args.end_frame)
